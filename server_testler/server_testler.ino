...
// Serial monitor'den veya Python'dan "T DROP_CMD <N>", "T CRC_CMD <N>",
// "T DROP_ACK <N>", "T STATUS", "T OFF" ile kontrol edilir.
...
// ====== TEST: Hata enjeksiyon komut isleyici (server tarafi) ======
...
void seriPortKomutKontrol() {
  while (Serial.available()) {
    ...
    if (c == '\n' || c == '\r') {
      ...
      // TEST: "T ..." komutlari ROBOT:KOMUT'tan once yakalanir
